		 ...
		 */
            ...
            function (require, module, exports) {
                ...
                defaults._set("radar", {
                    ...
                    elements: {
                        line: {tension: 0 // no bezier in radar
                        }
                    }
                });
 ...
 * @returns {ChartElement[]} the nearest items
 */
 ...
 */
		 ...
		 * @param e {Event} the event we are find things at
		 * @param options {IInteractionOptions} options to use during interaction
		 * @returns {Chart.Element[]} Array of elements that are under the point. If none are found, an empty array is returned
		 */
 ...
 */
	 ...
	 */
		 ...
		 * @returns {String|Array} the label to display
		 */
		 ...
		 * @returns {String} string representation of the tickValue parameter
		 */
 ...
 * @returns {Bounds} bounds of the bar
 * @private
 */
