...
(function () {
    ...
    function transformForSvg (_ref) {
        ...
        var outer = {transform: "translate(" + containerWidth / 2 + " 256)"};
        var innerTranslate = "translate(" + transform.x * 32 + ", " + transform.y * 32 + ") ";
        var innerScale = "scale(" + transform.size / 16 * (transform.flipX ? -1 : 1) + ", " + transform.size / 16 * (transform.flipY ? -1 : 1) + ") ";
        var innerRotate = "rotate(" + transform.rotate + " 0 0)";
        var inner = {transform: innerTranslate + " " + innerScale + " " + innerRotate};
        var path = {transform: "translate(" + iconWidth / 2 * -1 + " -256)"};
        return {
            outer: outer,
            inner: inner,
            path: path
    ...
    var asIcon = function (_ref) {
        ...
        if (transformIsMeaningful(transform) && main.found && !mask.found) {
            ...
            attributes.style = joinStyles(_extends({}, styles, {"transform-origin": offset.x + transform.x / 16 + "em " + (offset.y + transform.y / 16) + "em"}));
        }
 ...
 * @returns {mixed}                 The final result.
 */
    ...
    function observe (options) {
        ...
        mo.observe(DOCUMENT.getElementsByTagName("body")[0], {childList: true, attributes: true, characterData: true, subtree: true});
    }
